...
<div id="wrapper">
	<div id="bg_up">
		...
		<div class="clr"></div>
		<div id="designed_by">
			<p>All Age of Conan materials, logos, trademarks and other intellectual property are the property of FUNCOM, or its licensors.  (c) 2007  FUNCOM   All rights reserved.</p>
			<p>Design by: <a href="http://www.lernvid.com" title="templates" target="_blank">LernVid.com</a> feat. <a href="<?php echo $url2 ?>" target="_blank">game-template</a> sponsored by <a href="<?php echo $url ?>" target="_blank">Conan Guide</a></p>
		</div>
	</div>
</div>
